<fieldset class="border p-3 mb-4">
    <legend class="float-none w-auto px-2 fw-bold text-center w-100">Overall</legend>
    ...
    <div class="mb-4">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-1-comment" name="overall-1-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
    <div class="mb-4">
        <div class="row align-items-center mb-2">
            <div class="col-md-8">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-2-comment" name="overall-2-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
    <div class="mb-4">
        <div class="row align-items-center mb-2">
            <div class="col-md-8">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-3-comment" name="overall-3-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
    <div class="mb-4">
        <div class="row align-items-center mb-2">
            <div class="col-md-8">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-4-comment" name="overall-4-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
    <div class="mb-4">
        <div class="row align-items-center mb-2">
            <div class="col-md-8">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-5-comment" name="overall-5-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
    <div class="mb-4">
        <div class="row align-items-center mb-2">
            <div class="col-md-8">
        ...
        <textarea class="form-control mb-3 rounded-4" id="overall-6-comment" name="overall-6-comment" rows="2" style="resize:vertical;"></textarea>
    </div>
</fieldset>
