<fieldset class="border p-3 mb-4">
    <legend class="float-none w-auto px-2 fw-bold text-center w-100">Personal-Social</legend>
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            <tfoot>
                <tr>
                    <td colspan="5" class="text-end fw-bold" style="font-size:1.1rem;">PERSONAL-SOCIAL TOTAL</td>
                    <td>
                        <input type="text" class="form-control form-control-sm text-center" name="psoc-total" id="psoc-total" style="width:5em;" readonly>
                    </td>
                </tr>
            </tfoot>
        </table>
