...
function oe_module_lifemesh_telehealth_render_below_patient(AppointmentRenderEvent $event)
{
    ...
    <div>
        ...
        <div class="d-inline-block ml-2 mt-2">
            <div id="lifemesh-logo" style="display:none!important" class="d-inline-block bg-info" data-toggle="tooltip" data-placement="right" title="Lifemesh Telehealth Module status check is in process">
            ...
            <button type="button" class="ml-4 btn purple-btn white d-none" id="lifehealth-start" onclick="startSession()"><i class="mr-1 fas fa-video"></i><?php echo xlt("Start Session"); ?></button>
            <button type="button" class="ml-2 btn btn-danger white d-none" id="lifehealth-cancel" onclick="cancel_telehealth()"><?php echo xlt("Cancel Telehealth"); ?></button>
