    ...
    <section class="main-containerx" style="">
        ...
        <div class="inp_right_contents">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                ...
                <a href="#" style="margin-left: 10px;" class="btn-md btn btn-primary transferBtn" data-toggle="modal" data-target="#wardTransfer" data-pid="<?php echo $patient_id; ?>" data-bed="<?php echo $bed_id; ?>" data-ward="<?php echo $ward_id; ?>" data-admission_id="<?php echo $admission_id; ?>">
                    Ward Transfer
                </a>
            </div>
