    ...
    <table>
        <thead>
            <tr>
                ...
                <th scope="col"> <?php echo xlt('Type of Treatment') ?></th>
                <th scope="col"> <?php echo xlt('Instructions') ?> </th>
                <th scope="col"> <?php echo xlt('User') ?> </th>
                <th scope="col"> <?php echo xlt('Start Time') ?></th>
                <th scope="col"> <?php echo xlt('End Time') ?> </th>
                <th scope="col"> <?php echo xlt('Interval') ?> </th>
        ...
        <tbody>
            <?php foreach ($patientManagement['results'] as $key => $value) { ?>
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-primary editBtn" data-toggle="modal" data-target="#setTreatmentEdit" data-id="<?php echo $value['id']; ?>" data-action_id="<?php echo $value['action_id']; ?>" data-admission_id="<?php echo $value['admission_id']; ?>" data-patient_id="<?php echo $value['patient_id']; ?>" data-drug_id="<?php echo $value['drug_id']; ?>" data-action_start_time="<?php echo $value['action_start_time']; ?>" data-action_end_time="<?php echo $value['action_end_time']; ?>" data-staff_id="<?php echo $value['staff_id']; ?>" data-time_interval="<?php echo $value['time_interval']; ?>" data-instructions="<?php echo $value['instructions']; ?>"><?php echo xlt('Edit') ?></a>
                        <a href="#" class="btn btn-danger deleteBtn" data-id="<?php echo $value['id']; ?>"><?php echo xlt('Delete') ?></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
