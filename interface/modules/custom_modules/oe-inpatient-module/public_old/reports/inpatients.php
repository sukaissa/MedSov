...
if (isset($_GET['filters']) && $_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $inpatients = $inpatientQuery->filterInpatients($data);
}
...
<head>
    ...
    <title><?php echo xlt('Inpatient - Inpatient Report') ?></title>
...
<body class="container-fluid d-flex flex-column" style="padding-left: 30px; padding-right: 30px;">
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
        <h4 class="section-head"><?php echo xlt('Inpatients List') ?> (<?php echo $inpatients['total'] ?>)</h4>
    </div>
    ...
    <table>
        ...
        <?php foreach ($inpatients['results'] as $value) {
        ?>
            <tr>
