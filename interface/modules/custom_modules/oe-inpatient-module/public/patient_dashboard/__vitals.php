...
if (isset($_POST['treatment_plan']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    header("location:__treatment_plan.php?admission_id=$_POST[mng_admission_id]&patient_id=$_POST[mng_patient_id]&status=success&message=Clinical Management Plan added successfully");
    // header('Refresh:0');
}
...
<head>
    ...
    <title>Patient Dashboard - Vitals</title>
    ...
    <section class="main-containerx" style="">
        ...
        <div class="inp_right_contents">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                <h1>Vitals</h1>
                <a href="#" style="margin-left: 10px;" class="btn-md btn btn-primary setTreatmBtn" data-toggle="modal" data-target="#setTreatment" data-pid="<?php echo $patient_id; ?>" data-admission_id="<?php echo $admission_id; ?>">
                    Set Treatment
                </a>
            </div>
