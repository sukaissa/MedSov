...
<head>
    ...
    <script>
        ...
        function createFollowUpEncounter() {
            ...
            ?>
            var data = {
                encounterId: '<?php echo attr($encounterId); ?>',
        ...
        function queuePatient() {
            ...
            jQuery.ajax({
                type: "POST",
                url: 'admit_patient.php',
                dataType: 'json',
                data: {
                    functionname: 'addmission_queue_add'
                },
    ...
    <nav>
        ...
        <div id="encounter_forms" class="mx-1">
            <div class='encounter-summary-container'>
                ...
                <!-- TODO -->
                <!-- Check if the encounter is an inpatient encounter. To do this query form_encounter where class_code = IMP -->
                <!-- save into DB -->
                <button class="btn btn-primary float-right mr-2" onclick="queuePatient()" type="submit">Admit Patient</button>
            </div>
