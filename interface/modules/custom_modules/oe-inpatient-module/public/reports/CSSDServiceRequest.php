...
$cssd_service_request = new CSSDServiceQuery();
$department = new DepartmentQuery();



$providers = $authQuery->getProviders();
$all_service = $cssd_service_request->getCSSDService();
$all_department = $department->getDepartment();
...
if (isset($_GET['filters']) && $_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    $cssd =   $cssd_service_request->filterCSSDServiceRequest($data);
}
...
<head>
    ...
    <title>Inpatient - CSSD Service Request Report</title>
...
<body class="container-fluid d-flex flex-column" style="padding-left: 30px; padding-right: 30px;">
    ...
    <div class="search_container no_print">
        <form method="GET" style="display: flex; align-items: center;">
            ...
            <div class="form-group" style="margin-right: 10px;">
                <label for="service_id" style="margin-right: 5px;">Service Name</label>
            ...
            <div class="form-group" style="margin-right: 10px;">
                <label for="provider" style="margin-right: 5px;">Request By</label>
                <select class="form-control" id="request_by" name="request_by">
                    <option value="">Select Requester</option>
                    <?php foreach ($providers as $provider) { ?>
                        <option value="<?php echo $provider['id']; ?>"><?php echo $provider['fname'] ?> </option>
                    <?php
                    }  ?>
                </select>
            </div>
            ...
            <div class="form-group" style="margin-right: 5px;">
                <label for="status" style="margin-right: 5px;">Request Status</label>
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
        <h4 class="section-head">CSSD Service Request List</h4>
    </div>
    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $value['quantity_returned']; ?></td>
                <td><?php echo $value['request_by']; ?></td>
                <td><?php echo $value['status']; ?></td>
                <td><?php echo $value['request_date']; ?></td>
                <td><?php echo $value['request_processed_date']; ?></td>
                <td><?php echo $value['request_processed_by']; ?></td>
