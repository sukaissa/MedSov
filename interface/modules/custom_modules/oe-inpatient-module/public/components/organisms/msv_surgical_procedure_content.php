...
<main class="flex-1">
    ...
    <div class="bg-gradient-to-b h-[241px] from-[#FFA97F] to-[#ED2024] p-6">
        <div class="flex justify-between items-center">
            <p class="text-[32px] font-[500] text-white ml-16">Surgical Procedure</p>

            <button class="flex mr-16 rounded-md items-center w-[36px] h-[36px] bg-white justify-center" onclick="showFormsModal('surgicalProcedureForm')">
                +
            </button>
        </div>
    </div>
    ...
    <div class="flex w-full items-center flex-col justify-center">
        ...
        <div class="-mt-[150px] w-[1070px] min-h-[493px] bg-white p-[30px]">
            ...
            <?php include_once __DIR__ . '/tables/surgical_procedures_table.php'; ?>
