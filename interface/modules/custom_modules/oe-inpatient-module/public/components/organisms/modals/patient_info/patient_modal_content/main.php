<div id="patientModalMainContent">
    <div class="mt-6">
        <button class="w-full bg-[#FAFAFA] h-[64px] border-[#E7E7E7] border rounded-md flex items-center justify-center"
            onclick="showModalContent('printWristband')">
        ...
        <div class="grid grid-cols-3 gap-4 mb-6 mt-6">
            ...
            <button onclick="showModalContent('treatment')"
                ...
                <img src="./assets/img/msv-treatment-icon.svg" alt="Treatments Icon" class="mb-2 w-8 h-8 object-fit">
