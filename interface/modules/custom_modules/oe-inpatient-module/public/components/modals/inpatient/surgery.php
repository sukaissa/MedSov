            ...
            <div class="modal-body surgery-modal">
                <form method='POST' action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="form-group">
                        <label class="d-block" for="code">Code</label>
                        <select name="code" class="form-control d-flex flex-column" id="surgery_code"></select>
                    </div>

                    <div class="form-group">
                        <label for="formGroupExampleInput2">Theater Name</label>
