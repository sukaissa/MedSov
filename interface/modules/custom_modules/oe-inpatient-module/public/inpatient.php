            ...
            <div class="inpatient-item">
                <div style="display: flex;">
                    ...
                    <div style="margin-right: 60px;">
                        ...
                        <p> <?php echo xlt("Admission Type") ?>: <b><?php echo $value['admission_type']; ?></b></p>
...
<script>
    window.onload = function() {
        ...
        function formatOpt(source) {
            ...
            var $container = $(
                `<option class='clearfix' value='${source.procedure_code}'>${source.procedure_code} ${source.name} </option>`
            );
            return $container;
        }

        function formatRepoSelection(source) {
