        ...
        <tr>
          ...
          <div class="btn-group" role="group">
              ...
              <a href='#' class='btn btn-secondary btn-print' id='printbutton'>
                        ...
                        <a class="btn btn-secondary btn-transmit" onclick="exportCSV()" type="button" id="csv-button">Export CSV</a>
                        <?php } ?>
          </div>
                </div>
            </td>
...
<tbody>
    <?php
    //stores concantenated strings for the different forms
    $encounterNames = "";
    if ($res) {
        $lastdocname = "";
        $doc_encounters = 0;
            ...
            if ($form_details) {
                ...
                if ($encarr != '') {
                    foreach ($encarr as $enc) {
                        ...
                        //form encounter names
                        $encounterNames .= $enc['form_name'] . ", ";
                        $row['encounter_name'] = $encounterNames;
                    }
                }
...
<script>
function exportCSV(){
    let phpData = <?php echo json_encode($spreadsheetData); ?>;
        //Create a new workbook
        const wb = XLSX.utils.book_new();
        
        // Convert the PHP data to worksheet
        const ws = XLSX.utils.json_to_sheet(phpData);
