 ...
 * @copyright Copyright (c) 2008-2021 Rod Roark <rod@sunsrefretsystems.com>
 ...
 <tr>
  ...
  <td class='text' align='right'>
   ...
   /><?php echo xlt('Include Inactive'); ?>&nbsp;
    ...
    echo "   </select>&nbsp;\n";
    ?>
   <a href='#' class='btn btn-primary' onclick='mysubmit("submit")' style='margin-left:1em; color: white;'>
    <span><?php echo xlt('Refresh'); ?></span>
   </a>
   <a href='#' class='btn btn-primary' onclick='mysubmit("export")' style='margin-left:1em; color: white;'>
    <span><?php echo xlt('Export to CSV'); ?></span>
   </a>
   <a href='#' class='btn btn-primary' onclick='window.print()' style='margin-left:1em; color: white;' id='printbutton'>
