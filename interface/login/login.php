...
$viewArgs = [
    ...
    'tagline' => "Electronic Health Records (EHR) & Medical Practice Management System",
    'versionNumber' => "7.0.2",
    'versionTest' => "ver.",
    'poweredBy' => "Powered by OpenEMR",
    'certificationLabel' => "HIPAA Compliant & ONC Certified",
    ...
    'imageStaticRelative' => $GLOBALS['images_static_relative'],
    'primaryImageBackground' => $GLOBALS['images_static_relative'] . '/backgrounds/core/login/primary/background.png',
