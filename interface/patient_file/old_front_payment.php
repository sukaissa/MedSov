...
if (!empty($_POST['form_save']) || !empty($_REQUEST['receipt'])) {
    ...
    $patdata = getPatientData($form_pid, 'fname,mname,lname,pubpid,street,phone_cell');
            ...
            <div class="col-12 justify-content-center">
                ...
                <div class="main-section mb-5 mt-10">
                    ...
                    <div style="font-weight:600;">
                        <div><?php echo xlt("Bill to") . text(":"); ?></div>
                        <div><?php echo text($patdata['fname']) . " " . text($patdata['mname']) . " " . text($patdata['lname']); ?></div>
                        <div><?php echo text($patdata['street']); ?></div>
                        <div><?php echo text($patdata['phone_cell']); ?></div>
                    </div>
                    <div class="section-1">
