...
function generate_receipt($patient_id, $encounter = 0)
{
 //REMEMBER the entire receipt is generated here, have to echo DOC type etc and closing tags to create a valid webpsge
    ...
    <div class="row" style="color: #1d4a7e !important;">
            <h1>WELL CLINIC</h1>
        </div>
            <div class="row">
                <div class="col-6" style="color: #1d4a7e; font-weight: bold;">
                ...
                <div class="">
                    <table class="">
                        ...
                        <tr style="border:none !important">
                            ...
                            <td class='text-right' style="border:none !important">&nbsp;</td>
                            <td class='text-right bg-blue' style="border: 1px solid; color: white; background-color: #1d4a7e"><b><?php echo xlt('Total Charges'); ?></b></td>

                            <td class='text-right bg-blue' style="border: 1px solid; color: white; background-color: #1d4a7e"><?php echo text(oeFormatMoney($charges, true)) ?></td>
                        </tr>
                        <tr>
                            <td colspan='5'>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="border:none !important">&nbsp;</td>
                            <td style="border:none !important">&nbsp;</td>
                            <td class="font-weight-bold text-right bg-blue" style="border: 1px solid; color: white; background-color: #1d4a7e"><?php echo xlt('Balance Due'); ?></td>
                            <td class='text-right bg-blue' style="border: 1px solid; color: white; background-color: #1d4a7e"><?php echo text(oeFormatMoney($charges, true)) ?></td>
                        </tr>
                    </table>
                </div>
