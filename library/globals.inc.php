...
$GLOBALS_METADATA = array(
    ...
    'Branding' => [
        ...
        'machine_name' => [
            ...
            'text',
            'medsov',
            xl('The machine name of the application. Used spto identify the EMR in various messaging systems like HL7. Should not contain spaces'),
        ],
    ...
    'Login Page' => [
        'login_page_layout' => array(
            ...
            array(
                ...
                "login/layouts/medsov_custom_login_layout.html.twig" => xl("Medsov Custom Login"),
            ),
            'login/layouts/medsov_custom_login_layout.html.twig',
            // 'login/layouts/vertical_box.html.twig',
        ...
        'login_tagline_text' => [
            ...
            'text',
            xl("The most Advanced Electronic Health Record and Medical Practice Management solution."),
    ...
    'Features' => array(
        ...
        'speech_to_text' => array(
            ...
            'bool',                           // data type
            '0',                              // default true
            xl('Allow Speech-To-Text Module')
        ),
...
//                ,2 => xl('All apps Auto Approved') we could add this setting at a latter date
        ...
        'pathgroup_order_server' => array(
            xl('Pathgroup SFTP Host'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP hostname')
        ),
        'pathgroup_order_port' => array(
            xl('Pathgroup SFTP Port'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP Port')
        ),
        'pathgroup_order_username' => array(
            xl('Pathgroup SFTP username'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP Username')
        ),
        'pathgroup_order_password' => array(
            xl('Pathgroup SFTP Password'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP Password')
        ),
        'pathgroup_order_upload_path' => array(
            xl('Pathgroup SFTP Upload Path'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP Upload Path')
        ),
        'pathgroup_order_download_path' => array(
            xl('Pathgroup SFTP Download Path'),
            'text',                           // data type
            '',
            xl('Pathgroup SFTP Download Path')
        ),
