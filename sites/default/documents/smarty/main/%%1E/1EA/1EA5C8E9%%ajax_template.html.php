<?php /* Smarty version 2.6.33, created on 2025-03-03 11:56:11
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 11, false),array('function', 'xla', 'default/views/day/ajax_template.html', 166, false),array('function', 'xlt', 'default/views/day/ajax_template.html', 166, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 378, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 373, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 374, false),)), $this); ?>
...
<div id="viewPicker">
<?php 
echo "   <a href='#' onclick='printPatientDetails()' title='" . xla("Print Patient Demographics for Today") . "' class='btn btn-primary'>
...
<script>
    ...
    /**
     * Show print view of patients who have visits for today
     */
    var PrintToday = function (eventObject) {
        printURL = "<?php echo pnModURL(__POSTCALENDAR__,'user','view',
        array('tplview'=>($template_view ?? ''),
            'viewtype'=>$viewtype,
            'Date'=> $Date,
            ...
            'pc_category'=>($category ?? ''),
            'pc_topic'=>($topic ?? ''))); ?>";
        window.open('../../cal.php','printwindow','width=740,height=480,toolbar=no,location=no,directories=no,status=no,menubar=yes,scrollbars=yes,copyhistory=no,resizable=yes');
        return false;
    }
    ...
    {
        top.restoreSession();
        dlgopen('cal.php','_blank', 780, 650);
    }
